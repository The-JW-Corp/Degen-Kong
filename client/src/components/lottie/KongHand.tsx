...
interface KongHandProps {
  isWalletConnected: boolean;
}

const KongHand: React.FC<KongHandProps> = ({ isWalletConnected }) => {
  const playerRefKongHand = useRef<Player>(null);
  const buttonSuperiorHandURL = "https://lottie.host/f6468161-88cb-49c5-9865-b4ea43ad2e93/qDQIVRiM7o.json";
  const buttonInferiorHandURL = "https://lottie.host/52050add-59bc-4241-a702-5509d780ea80/DVKC0R61un.json";
